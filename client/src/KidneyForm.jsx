...
const KidneyForm = () => {
  const [formData, setFormData] = useState({
    bp: 80, sg: 1.020, al: 1, su: 0, rbc: 1
  });
  ...
  const labelMap = {
    bp: "Blood Pressure (mm/Hg)", sg: "Specific Gravity", al: "Albumin (0-5)", su: "Sugar (0-5)", rbc: "Red Blood Cells (0=Ab, 1=N)"
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white flex items-center gap-2"><TestTube className="text-warning"/> Nephrology Module</h1>
          <p className="text-sm text-gray-400 mt-1">Kidney disease risk assessment and automated telemetry</p>
        </div>
      </div>
